...
### 2. Conversaciones de Prueba

#### 📌 Pregunta 1: Conocimiento General
**Prompt:**
```
¿Qué es la inteligencia artificial y cuáles son sus principales aplicaciones actuales?
```
...
#### 📌 Pregunta 3: Comprensión del Español
**Prompt:**
```
Explícame el concepto de "soberanía de datos" y por qué es importante para las empresas europeas.
```
...
#### 📌 Pregunta 4: Razonamiento
**Prompt:**
```
Si tengo 3 cajas: una con manzanas, otra con naranjas y otra con manzanas y naranjas. 
Todas las etiquetas están mal puestas. Si solo puedo sacar una fruta de una caja, 
...
| **CPU** | [Completar] |
| **RAM** | [Completar] |
| **GPU** | [Completar o "Sin GPU dedicada"] |
| **Almacenamiento** | SSD |

#### Modelo Utilizado y Razón

**Modelo:** Qwen2.5:0.5b (398 MB)

**Razones de la elección:**
- Tamaño reducido ideal para hardware limitado
- Contexto amplio de 32K tokens (superior a otros modelos ligeros)
- Excelente soporte multilingüe, especialmente español
- Solo requiere 4 GB de RAM
- Licencia Apache 2.0 totalmente libre

#### Dificultades Encontradas

**[Describe aquí las dificultades que encontraste y cómo las resolviste]**

Ejemplo:
- Problema: Los contenedores tardaron en iniciar
- Solución: Esperé a que ambos servicios estuvieran completamente levantados antes de acceder

#### Comparativa: IA Local vs ChatGPT/Claude

| Aspecto | IA Local (Qwen2.5:0.5b) | ChatGPT/Claude |
|---------|-------------------------|----------------|
| **Privacidad** | ✅ Total, datos locales | ❌ Datos enviados a servidores externos |
| **Coste** | ✅ Gratuito tras configuración | ❌ Requiere suscripción |
| **Velocidad** | [Tu experiencia] | [Tu experiencia] |
| **Calidad** | Buena para tareas básicas | Superior en razonamiento complejo |
| **Disponibilidad** | ✅ Funciona offline | ❌ Requiere internet |
| **Contexto** | 32K tokens | 128K-200K tokens |

**Observaciones:**
[Escribe aquí tus observaciones personales sobre las diferencias]

#### Casos de Uso Empresarial

**Caso 1: Sistema de Atención al Cliente en Empresa de Seguros**
- **Problema:** Necesidad de procesar consultas con datos sensibles sin exponerlos a terceros
- **Solución:** IA local para mantener cumplimiento GDPR y privacidad total
- **Ventajas:** Sin costes por consulta, disponibilidad 24/7, datos nunca salen de la empresa

**Caso 2: Análisis de Documentación Técnica Confidencial**
- **Problema:** Empresa de ingeniería con propiedad intelectual que debe proteger
- **Solución:** Procesamiento local de planos y especificaciones técnicas
- **Ventajas:** Cero riesgo de filtración, procesamiento ilimitado, integrable con sistemas internos
